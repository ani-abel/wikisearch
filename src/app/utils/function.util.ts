...
//? dateFunctions.js - Begins
export const getSearchTerm = () => {
  const rawSearchTerm = (document.getElementById("search") as HTMLInputElement).value.trim();
  const regex = /[ ]{2,}/gi;
  const searchTerm = (rawSearchTerm as any).replaceAll(regex, " ");
  return searchTerm;
};
...
//? dateFunctions.js -Ends

//? main.js - Begins
export const processTheSearch = async (): Promise<SearchResultType[]> => {
  clearStatsLine();
